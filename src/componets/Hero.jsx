...
import { Mail, Phone, Download, ChevronDown, MessageCircle } from 'lucide-react';
  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-1000 text-white">
        ...
        <h2 className="text-[16px] md:text-[22px] font-semibold text-blue-400 mb-6 tracking-wide">
          Mern Stack Developer | React JS Developer| Node.js | Express.js | MongoDb 
        </h2>

        <p className="text-gray-200 text-sm md:text-base leading-relaxed mb-8 max-w-3xl mx-auto">
          I am Roshan Bhagat, a Frontend Developer based in India specializing in React.js, 
          JavaScript, and modern web development. I build fast, scalable, and 
          SEO-friendly web applications for startups and businesses.
        </p>

        {/* Contact Info */}
        <div className="flex flex-wrap items-center justify-center gap-6 mb-10 text-sm md:text-base font-medium">
          <a href="mailto:jhashivam3003@gmail.com" className="flex items-center gap-2  transition">
            <Mail size={18} className="text-indigo-400" />
            bhagatroshan1822@gmail.com
          </a>
          <a href="tel:+916355278751" className="flex items-center gap-2  transition">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-bold flex items-center gap-2 transition-all shadow-lg">
            <Download size={20} />
          ...
          <button className="border-2 border-gray-300 hover:bg-white/10 text-white px-8 py-3 rounded-lg font-bold transition-all">
            Learn More
          </button>
        </div>
      </div>
